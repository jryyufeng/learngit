...
if __name__ == '__main__':
    ...
    r = requests.get('https://www.zhihu.com/people/jianzu1126/answers').content
    print r
    bs = BeautifulSoup(r,"lxml")
    image = bs.find(attrs={"class":"Avatar Avatar--large UserAvatar-inner"})["src"]

    ir = requests.get(image)
    with open('D:/logo1.jpg','wb') as f:
        f.write(ir.content)
