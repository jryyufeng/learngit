...
class get():
    ...
    def denglu(self,client):
        try:
            if os.path.isfile(TOKEN_FILE):
                ...
                client.login('15169133351', 'jry123456')
    ...
    def Analyse_answer(self,list_q):
        ...
        for an in list_a:
            ...
            # answer_content=an[10]
            # dic_3["answer_content"]=answer_content[0:30]
            str_qb = " "
        ...
        # strlist_1=str(list_1)#############################################
        # filelist1=open("F:/zhihu/answer/people_list.txt",'w')
        # filelist1.write(strlist_1+'\n')
        # filelist1.close()
        #print list_1
